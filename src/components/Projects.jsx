...
function Projects(user) {
    ...
    return (
        <>
            <div>
                <div className="md:px-24 pl-3 md:py-16 py-8 px-4">
                    <h1 className=" text-xl font-medium font-mono">Projects</h1>
                    <div className="md:grid-cols-3 grid grid-cols-1 gap-6 pt-4">
                        {projectData
                            ? projectData.map((ele) => {
                                  return (
                                      <div className="md:w-96 w-80 h-72  rounded-md ring-1 ring-zinc-600 space-y-4 hover:cursor-pointer  transition ease-in-out delay-150  hover:-translate-y-0 hover:scale-110  duration-300">
